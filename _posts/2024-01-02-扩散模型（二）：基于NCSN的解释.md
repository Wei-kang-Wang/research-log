...
![4]({{ '/assets/images/diffusion_4.png' | relative_url }}){: width=800px style="float:center"} 
...
![5]({{ '/assets/images/diffusion_5.png' | relative_url }}){: width=800px style="float:center"} 
...
![6]({{ '/assets/images/diffusion_6.png' | relative_url }}){: width=800px style="float:center"} 
...
![8]({{ '/assets/images/diffusion_8.png' | relative_url }}){: width=800px style="float:center"} 
...
![10]({{ '/assets/images/diffusion_10.png' | relative_url }}){: width=800px style="float:center"} 
