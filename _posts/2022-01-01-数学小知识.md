...
![v1]({{ '/assets/images/V-1.PNG' | relative_url }}){: width=800px style="float:center"} 
...
![v2]({{ '/assets/images/V-2.PNG' | relative_url }}){: width=800px style="float:center"} 
