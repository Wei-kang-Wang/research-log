...
![feature scaling]({{ '/assets/images/batch_normalization_1.png' | relative_url }}){: width=800px style="float:center"} 

**Feature Scaling的算法**

对于第i个维度的每一个data，都减去该维度的mean，再除以该维度的standard deviation。如fig 2所示。

![feature scaling algorithm]({{ '/assets/images/batch_normalization_2.png' | relative_url }}){: width=800px style="float:center"} 
...
![feature scaling nn]({{ '/assets/images/batch_normalization_3.png' | relative_url }}){: width=800px style="float:center"} 
...
![bn]({{ '/assets/images/batch_normalization_4.png' | relative_url }}){: width=800px style="float:center"} 
...
![fbn]({{ '/assets/images/batch_normalization_5.png' | relative_url }}){: width=800px style="float:center"} 
...
![fbnt]({{ '/assets/images/batch_normalization_6.png' | relative_url }}){: width=800px style="float:center"} 
...
![t1]({{ '/assets/images/TSNE-1.PNG' | relative_url }}){: width=800px style="float:center"} 


下图是t-SNE优化好了的一个结果。


![t2]({{ '/assets/images/TSNE-2.PNG' | relative_url }}){: width=800px style="float:center"} 
...
![gap1]({{ '/assets/images/GAP-1.PNG' | relative_url }}){: width=800px style="float:center"} 
